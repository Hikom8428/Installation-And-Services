...
import { LayoutDashboard, Users, FileText, ClipboardList, LogOut, Wrench, Menu, MapPin, X, BookOpen, BarChart3 } from "lucide-react";
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { name: "Reports", href: "/dashboard/reports", icon: BarChart3, show: session.user.role === "MASTER" || session.user.role === "ADMIN" || session.user.role === "MANAGER" },
